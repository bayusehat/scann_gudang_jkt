...
<body>
    <div class="paper">
        <table id="tableIn" class="table table-striped table-bordered table-sm" style="width:100%;padding-top:20px">
            <thead>
                <tr>
                    <th colspan="28" class="title"><center><div style="top:30;left:50;font-size:30px;font-weight:50"><h1>Laporan Stok Keluar</h1></div></center>
            ...
            <tbody>
                ...
                @foreach ($data['data'] as $i => $item)
                    @php
                        $total_akhir += $item->grand_total_akhir;
                    @endphp
                    <tr>
                        <td>{{ ++$i }}</td>
                        <td>{{ $item->artikel }}</td>
